...
public class ParticipationServiceImpl implements ParticipationServices {
    ...
    @Override
    public Optional<ParticipationDto> findOne(Long athleteId, Long eventId) {
        return participationRepository.findByAthleteIdAndEventId(athleteId, eventId).map(participationMapper::mapTo);
    }

    @Override
    public boolean isExists(Long athleteId, Long eventId) {
        return participationRepository.existsByAthleteIdAndEventId(athleteId, eventId);
    }

    @Override
    public ParticipationDto partialUpdate(Long athleteId, Long eventId, ParticipationDto participationDto) {
    ...
    @Override
    public void delete(Long athleteId, Long eventId) {
