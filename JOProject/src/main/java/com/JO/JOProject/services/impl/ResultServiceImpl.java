...
public class ResultServiceImpl implements ResultServices {
    ...
    public ResultServiceImpl(ResultRepository resultRepository, Mapper<ResultEntity, ResultDto> resultMapper) {
    ...
    @Override
    public Optional<ResultDto> findOne(Integer id) {
    ...
    @Override
    public ResultDto partialUpdate(Integer id, ResultDto resultDto) {
