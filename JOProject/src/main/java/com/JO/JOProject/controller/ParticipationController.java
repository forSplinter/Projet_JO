...
public class ParticipationController {
    ...
    public ResponseEntity<ParticipationDto> getParticipationById(@PathVariable Integer athleteId, @PathVariable Integer eventId) {
    ...
    public ResponseEntity<ParticipationDto> updateParticipation(@PathVariable Integer athleteId, @PathVariable Integer eventId, @RequestBody ParticipationDto participationDto) {
    ...
    public ResponseEntity<Void> deleteParticipation(@PathVariable Integer athleteId, @PathVariable Integer eventId) {
